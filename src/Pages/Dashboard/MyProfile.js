            ...
            <div className="min-h-[60vh]">
                <form onSubmit={handleuserUpdate} className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <input required ref={education} type="text" placeholder="education" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text">location</span>
                        </label>
                        <input required ref={location} type="text" placeholder="location" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text">Phone number</span>
                        </label>
                        <input required ref={phone} type="tel" placeholder="Phone number" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text">LinkedIn</span>
                        </label>
                        <input required ref={LinkedIn} type="text" placeholder="LinkedIn" className="input input-bordered" />
                    </div>
