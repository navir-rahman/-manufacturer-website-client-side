            ...
            <section>
                <div className="hero min-h-[60vh] bg-base-200">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <div>
                            <h1 className="text-5xl font-bold">Abdur Rahman</h1>
                            <p className="py-6">I am a Front End Developer</p>
                            <button type='email' className="btn btn-primary">Abdur_Rahman@mail.com</button>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="hero min-h-[60vh] bg-base-200">
                    <div className="hero-content flex-col lg:flex-row">
                        <div>
                            ...
                            <p className="py-6"><b> Expertise:</b>  React.js, HTML-5, CSS-3, Vanila JavaScript, Bootstrap, React, React Router, React Hook, </p>
                        ...
                        <div>
                            ...
                            <p className="py-6">Ecommerce (Horns) May 2018 – Present <br />
            ...
            <section className='grid grid-cols-2 gap-20'>
                ...
                <div className="card bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p className="py-6">– Service based website</p>
                        <p>● Features</p>
                        <ul>
                            <li>
